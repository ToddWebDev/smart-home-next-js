...
const HorizontalCard: React.FC<HorizontalCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center rounded-lg border border-gray-200 bg-white shadow-sm md:flex-row dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="max-w-none p-6 md:max-w-sm lg:max-w-xl">
        <a href={linkHref}>
